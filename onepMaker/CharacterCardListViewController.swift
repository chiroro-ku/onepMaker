...
class CharacterCardListViewController: UIViewController {
...
extension CharacterCardListViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
