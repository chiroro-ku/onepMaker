...
class LeadCardsViewController: UIViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "toLeadCardViewController"{
            ...
            leadCardViewController?.leadCard = self.selectedLeadCard
        }
    }
}

extension LeadCardsViewController: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath){
        self.selectedLeadCard = self.leadCardList[indexPath.row]
